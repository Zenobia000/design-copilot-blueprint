# 00-discover — What problem are we solving?
...
| #   | Document | Status |
|-----|----------|--------|
| E1  | [E1--project-brief-and-prd](E1--project-brief-and-prd.md) | Approved (v3.0) |
...
- [E1x--competitive-landscape](E1x--competitive-landscape.md) — 競品分析
- [E1x--market-sizing](E1x--market-sizing.md) — 市場規模估算 (Draft — 待數據驗證)
- [E1x--stakeholder-brief](E1x--stakeholder-brief.md) — 利害關係人簡報 (合併自 Executive Summary + BD Pitch)

## Extended Documents — Compliance

- [E1x--privacy-compliance-seed](E1x--privacy-compliance-seed.md) — 隱私與合規種子文件 (Seed — 需法務審查)
